...
public class Comparators {
    ...
    public static Comparator<Libro> perTitolo = Comparator.comparing(Libro::getTitolo, Comparator.nullsLast(String::compareToIgnoreCase));

    public static Comparator<Libro> perAutore = Comparator.comparing(Libro::getAutore, Comparator.nullsLast(String::compareToIgnoreCase));

    public static Comparator<Libro> perGenere = Comparator.comparing(Libro::getGenere, Comparator.nullsLast(String::compareToIgnoreCase));
